...
function TablePaginationActions(props) {
   ...
   // this is  table data  start//
    const rows = [
      ...
      createData('Radio Certificate',<TextField sx={{ m: 1, width: '20ch'}} size="small"/>, <TextField sx={{ m: 1, width: '20ch'}} size="small"/>,<TextField sx={{ m: 1, width: '20ch'}} size="small"/>, <TextField sx={{ m: 1, width: '20ch'}} size="small"/>, '(max 13mb)',),
      createData('RSVM', 356, 'SP-EFGH','', '0', '(max 13mb)',),
      createData('Radio Certificate', 408, 'SP-UKL',<TextField sx={{ m: 1, width: '10ch'}} />, '0'),
