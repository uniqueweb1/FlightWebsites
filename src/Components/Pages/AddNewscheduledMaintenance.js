...
export default function AddNewscheduledMaintenance() {
...
{/*return all form input */}
   ...
   <span>Name</span>
   <TextField
   sx={{ m: 1, width: '35ch' , border:'1px solid #000', borderRadius: '5px'}}
    id="fullWidth"
  ...
  <div className="form-itemss">
   ...
   <TextField
   sx={{ m: 1, width: '25ch', border:'1px solid #000', borderRadius: '5px'}}
          required
...
<TimePicker
      ...
      <div>
        <span>TAH</span>
      <TextField
      sx={{ m: 1, width: '15ch',border:'1px solid #000', borderRadius: '5px'}}
          required
          id="outlined-required"
      ...
      <DesktopDatePicker
          ...
          value={value}
          onChange={handleNewChange}
          renderInput={(params) => <TextField {...params} sx={{ m: 1, width: '16ch',border:'1px solid #000', borderRadius: '5px' }} />}
        />
      </div>
      </div>
 ...
 <div className="Aircraft">Schedule Maintenance option</div>
  <div className="formcontainer-item">
   ...
   <FormControlLabel
        ...
        <div className="delete-conflit">
      <Button variant="contained" align="center">Add Scheduled Maintenance</Button>
      </div>
    </Stack>
    </div>
    </Stack>
